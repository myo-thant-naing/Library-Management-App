...
export default function Navbar() {
  ...
  return (
    <div>
      <nav
        className={`hidden md:block border border-b-2 shadow-lg ${
          isDark ? "bg-dbg border-primary shadow-rose-950" : ""
        }`}
      >
        <ul className="flex  justify-between items-center p-3 max-w-6xl  mx-auto">
          ...
          <Link
            to={"/"}
            className="flex items-center gap-3 md:s-ml-32 cursor-pointer "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <span className="text-2xl font-bold text-primary ">Book Store</span>
          </Link>
